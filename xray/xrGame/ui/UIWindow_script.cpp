...
void CUIWindow::script_register(lua_State *L)
{
	...
	[
		...
		.def("ClearPages",					&CUIMMShniaga::ClearPages)
		.def("ShowPage",					&CUIMMShniaga::ShowPage)
		.def("PageCount",					&CUIMMShniaga::PageCount)
		.def("CurrentPageId",				&CUIMMShniaga::CurrentPageId)
		.def("SelectBtn",					(void (CUIMMShniaga::*)(int))			&CUIMMShniaga::SelectBtn)
		.def("SelectBtn",					(void (CUIMMShniaga::*)(CUIWindow*))	&CUIMMShniaga::SelectBtn)
		.def("BtnCount",					&CUIMMShniaga::BtnCount),
